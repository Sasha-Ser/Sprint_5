...
class TestEnterInAccount:
    ...
    def test_enter_through_personal_cabinet_button_true(self):
    ...
    def test_enter_through_enter_in_account_button_true(self):
        driver = webdriver.Chrome()
        driver.get("https://stellarburgers.nomoreparties.site/")
    ...
    def test_enter_through_registration_page_true(self):
        driver = webdriver.Chrome()
    ...
    def test_enter_through_forgot_page_true(self):
        driver = webdriver.Chrome()
